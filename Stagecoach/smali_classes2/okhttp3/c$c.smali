...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/c$c$a;-><init>(Lkotlin/jvm/internal/f;)V
    ...
    invoke-virtual {v2}, Lokhttp3/d0/h/h;->g()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lokhttp3/d0/h/h;->g()Ljava/lang/String;
...
.method public constructor <init>(Lokhttp3/a0;)V
    ...
    invoke-virtual {v0, p1}, Lokhttp3/c$b;->f(Lokhttp3/a0;)Lokhttp3/s;
...
.method public constructor <init>(Lokio/z;)V
    ...
    .line 9
    sget-object v1, Lokhttp3/d0/e/k;->d:Lokhttp3/d0/e/k$a;

    invoke-interface {v0}, Lokio/h;->p0()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Lokhttp3/d0/e/k$a;->a(Ljava/lang/String;)Lokhttp3/d0/e/k;

    move-result-object v1

    .line 10
    iget-object v2, v1, Lokhttp3/d0/e/k;->a:Lokhttp3/Protocol;

    iput-object v2, p0, Lokhttp3/c$c;->d:Lokhttp3/Protocol;

    .line 11
    iget v2, v1, Lokhttp3/d0/e/k;->b:I

    iput v2, p0, Lokhttp3/c$c;->e:I

    .line 12
    iget-object v1, v1, Lokhttp3/d0/e/k;->c:Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lokhttp3/s$a;->f(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v5}, Lokhttp3/s$a;->f(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .line 18
    invoke-virtual {v1, v2}, Lokhttp3/s$a;->h(Ljava/lang/String;)Lokhttp3/s$a;

    .line 19
    invoke-virtual {v1, v5}, Lokhttp3/s$a;->h(Ljava/lang/String;)Lokhttp3/s$a;
    ...
    .line 27
    sget-object v2, Lokhttp3/h;->u:Lokhttp3/h$b;
    ...
    .line 28
    invoke-direct {p0, v0}, Lokhttp3/c$c;->c(Lokio/h;)Ljava/util/List;
...
.method private final a()Z
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lkotlin/text/k;->H(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
...
.method private final c(Lokio/h;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/c$b;->c(Lokio/h;)I
    ...
    invoke-virtual {v5, v4}, Lokio/f;->i1(Lokio/ByteString;)Lokio/f;

    .line 8
    invoke-virtual {v5}, Lokio/f;->J0()Ljava/io/InputStream;
...
.method private final e(Lokio/g;Ljava/util/List;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lokio/g;->G0(J)Lokio/g;
    ...
    .line 5
    invoke-interface {p1, v3}, Lokio/g;->X(Ljava/lang/String;)Lokio/g;

    move-result-object v3

    invoke-interface {v3, v1}, Lokio/g;->F(I)Lokio/g;
    :try_end_0
...
.method public final b(Lokhttp3/y;Lokhttp3/a0;)Z
    ...
    invoke-virtual {v0, p2, v1, p1}, Lokhttp3/c$b;->g(Lokhttp3/a0;Lokhttp3/s;Lokhttp3/y;)Z
...
.method public final d(Lokhttp3/internal/cache/DiskLruCache$c;)Lokhttp3/a0;
    ...
    invoke-virtual {v0, v1}, Lokhttp3/s;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lokhttp3/s;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Lokhttp3/y$a;->i(Ljava/lang/String;)Lokhttp3/y$a;
    ...
    invoke-virtual {v2, v3}, Lokhttp3/y$a;->e(Lokhttp3/s;)Lokhttp3/y$a;
    ...
    invoke-virtual {v3, v2}, Lokhttp3/a0$a;->p(Lokhttp3/Protocol;)Lokhttp3/a0$a;

    .line 11
    iget v2, p0, Lokhttp3/c$c;->e:I

    invoke-virtual {v3, v2}, Lokhttp3/a0$a;->g(I)Lokhttp3/a0$a;

    .line 12
    iget-object v2, p0, Lokhttp3/c$c;->f:Ljava/lang/String;

    invoke-virtual {v3, v2}, Lokhttp3/a0$a;->m(Ljava/lang/String;)Lokhttp3/a0$a;

    .line 13
    iget-object v2, p0, Lokhttp3/c$c;->g:Lokhttp3/s;

    invoke-virtual {v3, v2}, Lokhttp3/a0$a;->k(Lokhttp3/s;)Lokhttp3/a0$a;

    .line 14
    new-instance v2, Lokhttp3/c$a;

    invoke-direct {v2, p1, v0, v1}, Lokhttp3/c$a;-><init>(Lokhttp3/internal/cache/DiskLruCache$c;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v3, v2}, Lokhttp3/a0$a;->b(Lokhttp3/b0;)Lokhttp3/a0$a;

    .line 15
    iget-object p1, p0, Lokhttp3/c$c;->h:Lokhttp3/Handshake;

    invoke-virtual {v3, p1}, Lokhttp3/a0$a;->i(Lokhttp3/Handshake;)Lokhttp3/a0$a;

    .line 16
    iget-wide v0, p0, Lokhttp3/c$c;->i:J

    invoke-virtual {v3, v0, v1}, Lokhttp3/a0$a;->s(J)Lokhttp3/a0$a;

    .line 17
    iget-wide v0, p0, Lokhttp3/c$c;->j:J

    invoke-virtual {v3, v0, v1}, Lokhttp3/a0$a;->q(J)Lokhttp3/a0$a;

    .line 18
    invoke-virtual {v3}, Lokhttp3/a0$a;->c()Lokhttp3/a0;
...
.method public final f(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 1
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->f(I)Lokio/x;
    ...
    invoke-interface {p1, v3, v4}, Lokio/g;->G0(J)Lokio/g;
    ...
    invoke-interface {p1, v5}, Lokio/g;->X(Ljava/lang/String;)Lokio/g;

    move-result-object v5

    .line 7
    invoke-interface {v5, v4}, Lokio/g;->X(Ljava/lang/String;)Lokio/g;
    ...
    invoke-virtual {v5, v3}, Lokhttp3/s;->s(I)Ljava/lang/String;

    move-result-object v5

    invoke-interface {v4, v5}, Lokio/g;->X(Ljava/lang/String;)Lokio/g;

    move-result-object v4

    .line 9
    invoke-interface {v4, v2}, Lokio/g;->F(I)Lokio/g;
    ...
    .line 10
    :cond_0
    new-instance v1, Lokhttp3/d0/e/k;
    ...
    invoke-direct {v1, v3, v5, v6}, Lokhttp3/d0/e/k;-><init>(Lokhttp3/Protocol;ILjava/lang/String;)V

    invoke-virtual {v1}, Lokhttp3/d0/e/k;->toString()Ljava/lang/String;
    ...
    invoke-interface {p1, v5, v6}, Lokio/g;->G0(J)Lokio/g;
    ...
    invoke-virtual {v5, v0}, Lokhttp3/s;->s(I)Ljava/lang/String;
    ...
    .line 16
    invoke-interface {v3, v2}, Lokio/g;->F(I)Lokio/g;
    ...
    invoke-interface {v0, v5, v6}, Lokio/g;->G0(J)Lokio/g;
    ...
    invoke-interface {v0, v3, v4}, Lokio/g;->G0(J)Lokio/g;
    ...
    .line 26
    invoke-interface {p1, v2}, Lokio/g;->F(I)Lokio/g;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/c$c;->e(Lokio/g;Ljava/util/List;)V
