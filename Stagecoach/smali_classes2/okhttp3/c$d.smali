...
# instance fields
.field private final a:Lokio/x;

.field private final b:Lokio/x;
...
.method public constructor <init>(Lokhttp3/c;Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 2
    invoke-virtual {p2, p1}, Lokhttp3/internal/cache/DiskLruCache$Editor;->f(I)Lokio/x;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/c$d;->a:Lokio/x;

    .line 3
    new-instance p2, Lokhttp3/c$d$a;

    invoke-direct {p2, p0, p1}, Lokhttp3/c$d$a;-><init>(Lokhttp3/c$d;Lokio/x;)V

    iput-object p2, p0, Lokhttp3/c$d;->b:Lokio/x;

    return-void
.end method

.method public static final synthetic b(Lokhttp3/c$d;)Lokhttp3/internal/cache/DiskLruCache$Editor;
    .locals 0
...
.method public a()V
    ...
    invoke-virtual {v2}, Lokhttp3/c;->h()I

    move-result v3

    add-int/2addr v3, v1

    invoke-virtual {v2, v3}, Lokhttp3/c;->L(I)V
    :try_end_1
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/c$d;->a:Lokio/x;
...
.method public body()Lokio/x;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/c$d;->b:Lokio/x;
