...
.method private final a(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/builtins/PrimitiveType;)Lkotlin/reflect/jvm/internal/impl/resolve/constants/b;
    ...
    invoke-direct {p2, v0, p1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/b;-><init>(Ljava/util/List;Lkotlin/jvm/b/l;)V
...
# virtual methods
.method public final b(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/y;)Lkotlin/reflect/jvm/internal/impl/resolve/constants/b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/ConstantValueFactory$createArrayValue$1;-><init>(Lkotlin/reflect/jvm/internal/impl/types/y;)V

    invoke-direct {v0, p1, v1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/b;-><init>(Ljava/util/List;Lkotlin/jvm/b/l;)V
...
.method public final c(Ljava/lang/Object;)Lkotlin/reflect/jvm/internal/impl/resolve/constants/g;
    ...
    invoke-direct {v0, p1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/t;-><init>(S)V
    ...
    invoke-direct {v0, v1, v2}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/q;-><init>(J)V
    ...
    invoke-direct {v0, p1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/u;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lkotlin/collections/d;->L([B)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/d;->S([S)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/d;->P([I)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/d;->Q([J)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/d;->M([C)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/d;->O([F)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/d;->N([D)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/d;->T([Z)Ljava/util/List;
    ...
    .line 18
    new-instance v0, Lkotlin/reflect/jvm/internal/impl/resolve/constants/r;

    invoke-direct {v0}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/r;-><init>()V
