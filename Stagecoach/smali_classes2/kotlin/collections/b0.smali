...
.method public static varargs h([Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/b0;->o([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final i(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lkotlin/collections/a0;->d(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final k(Ljava/util/Map;[Lkotlin/Pair;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static l(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/b0;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lkotlin/collections/y;->c(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/b0;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    invoke-static {v0}, Lkotlin/collections/b0;->i(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p1, p0}, Lkotlin/collections/b0;->j(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static n(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    invoke-static {p0}, Lkotlin/collections/y;->p(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final o([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    .line 1
    invoke-static {p1, p0}, Lkotlin/collections/b0;->k(Ljava/util/Map;[Lkotlin/Pair;)V
