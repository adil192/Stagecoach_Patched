...
.field public final context:Lio/realm/internal/f;
...
.method private constructor <init>(JLio/realm/internal/OsRealmConfig;)V
    ...
    .line 32
    invoke-virtual {p3}, Lio/realm/internal/OsRealmConfig;->a()Lio/realm/internal/f;

    move-result-object v0

    iput-object v0, p0, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/f;
    ...
    iput-object v0, p0, Lio/realm/internal/OsSharedRealm;->capabilities:Lio/realm/internal/a;
    ...
    .line 38
    iget-object v1, p2, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/f;
...
.method private constructor <init>(Lio/realm/internal/OsRealmConfig;Lio/realm/internal/OsSharedRealm$a;)V
    ...
    .line 5
    new-instance v1, Lio/realm/internal/android/a;

    invoke-direct {v1}, Lio/realm/internal/android/a;-><init>()V
    ...
    .line 7
    invoke-virtual {p1}, Lio/realm/internal/OsRealmConfig;->a()Lio/realm/internal/f;

    move-result-object v10

    iput-object v10, p0, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/f;
    ...
    iget-wide v4, p2, Lio/realm/internal/OsSharedRealm$a;->c:J

    iget-wide v6, p2, Lio/realm/internal/OsSharedRealm$a;->d:J
    ...
    .line 14
    invoke-virtual {v10, p0}, Lio/realm/internal/f;->a(Lio/realm/internal/g;)V
    ...
    .line 18
    invoke-interface {v1}, Lio/realm/internal/a;->a()Z
...
.method private detachIterators()V
    ...
    check-cast v1, Lio/realm/internal/OsResults$m;

    if-eqz v1, :cond_0

    .line 3
    invoke-virtual {v1}, Lio/realm/internal/OsResults$m;->detach()V
...
.method private executePendingRowQueries()V
    ...
    .line 3
    invoke-virtual {v1}, Lio/realm/internal/j;->c()V
...
.method public static getInstance(Lio/realm/RealmConfiguration;Lio/realm/internal/OsSharedRealm$a;)Lio/realm/internal/OsSharedRealm;
    .locals 1

    .line 1
    new-instance v0, Lio/realm/internal/OsRealmConfig$b;

    invoke-direct {v0, p0}, Lio/realm/internal/OsRealmConfig$b;-><init>(Lio/realm/RealmConfiguration;)V
...
.method public static getInstance(Lio/realm/internal/OsRealmConfig$b;Lio/realm/internal/OsSharedRealm$a;)Lio/realm/internal/OsSharedRealm;
    ...
    .line 3
    invoke-virtual {p0}, Lio/realm/internal/OsRealmConfig$b;->b()Lio/realm/internal/OsRealmConfig;
    ...
    invoke-virtual {v0, p0}, Lio/realm/internal/h;->m(Lio/realm/internal/OsRealmConfig;)V

    .line 5
    new-instance v0, Lio/realm/internal/OsSharedRealm;

    invoke-direct {v0, p0, p1}, Lio/realm/internal/OsSharedRealm;-><init>(Lio/realm/internal/OsRealmConfig;Lio/realm/internal/OsSharedRealm$a;)V
...
# virtual methods
.method addIterator(Lio/realm/internal/OsResults$m;)V
    .locals 2
...
.method addPendingRow(Lio/realm/internal/j;)V
    .locals 2
...
.method public close()V
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/f;
...
.method invalidateIterators()V
    ...
    .line 3
    invoke-virtual {v1}, Lio/realm/internal/OsResults$m;->invalidate()V
...
.method removePendingRow(Lio/realm/internal/j;)V
    .locals 3
