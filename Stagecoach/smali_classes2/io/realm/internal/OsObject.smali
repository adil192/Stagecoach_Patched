...
.method public constructor <init>(Lio/realm/internal/OsSharedRealm;Lio/realm/internal/UncheckedRow;)V
    ...
    iput-object v0, p0, Lio/realm/internal/OsObject;->observerPairs:Lio/realm/internal/i;
...
.method public static create(Lio/realm/internal/Table;)Lio/realm/internal/UncheckedRow;
    ...
    .line 1
    invoke-virtual {p0}, Lio/realm/internal/Table;->s()Lio/realm/internal/OsSharedRealm;
    ...
    iget-object v0, v0, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/f;
    ...
    invoke-direct {v1, v0, p0, v2, v3}, Lio/realm/internal/UncheckedRow;-><init>(Lio/realm/internal/f;Lio/realm/internal/Table;J)V
...
.method public static createRowWithPrimaryKey(Lio/realm/internal/Table;JLjava/lang/Object;)J
    ...
    .line 1
    invoke-virtual/range {p0 .. p2}, Lio/realm/internal/Table;->p(J)Lio/realm/RealmFieldType;
...
.method public static createWithPrimaryKey(Lio/realm/internal/Table;Ljava/lang/Object;)Lio/realm/internal/UncheckedRow;
    ...
    .line 2
    invoke-virtual {p0, v4, v5}, Lio/realm/internal/Table;->p(J)Lio/realm/RealmFieldType;
    ...
    iget-object v8, v1, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/f;
    ...
    iget-object v10, v1, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/f;
...
.method private static getAndVerifyPrimaryKeyColumnIndex(Lio/realm/internal/Table;)J
    ...
    .line 2
    invoke-virtual {p0, v0}, Lio/realm/internal/Table;->m(Ljava/lang/String;)J
...
.method private notifyChangeListeners([Ljava/lang/String;)V
    ...
    .line 1
    iget-object v0, p0, Lio/realm/internal/OsObject;->observerPairs:Lio/realm/internal/i;
...
.method public addListener(Lio/realm/RealmModel;Lio/realm/RealmObjectChangeListener;)V
    ...
    invoke-direct {v0, p1, p2}, Lio/realm/internal/OsObject$b;-><init>(Lio/realm/RealmModel;Lio/realm/RealmObjectChangeListener;)V

    .line 4
    iget-object p1, p0, Lio/realm/internal/OsObject;->observerPairs:Lio/realm/internal/i;
...
.method public removeListener(Lio/realm/RealmModel;)V
    ...
    invoke-virtual {v0, p1}, Lio/realm/internal/i;->f(Ljava/lang/Object;)V
...
.method public setObserverPairs(Lio/realm/internal/i;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/realm/internal/OsObject;->observerPairs:Lio/realm/internal/i;
