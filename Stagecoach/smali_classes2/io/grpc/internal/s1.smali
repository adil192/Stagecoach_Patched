...
.method static b(Ljava/util/Map;)Ljava/lang/Long;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, v0}, Lio/grpc/internal/s0;->l(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Long;
...
.method static c(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p0, v0}, Lio/grpc/internal/s0;->j(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Map;
...
.method private static e(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Set;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, p1}, Lio/grpc/internal/s0;->e(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lio/grpc/internal/s1;->s(Ljava/util/List;)Ljava/util/Set;
...
.method public static f(Ljava/util/Map;)Ljava/util/List;
    ...
    .line 3
    invoke-static {p0, v1}, Lio/grpc/internal/s0;->f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 5
    invoke-static {p0, v1}, Lio/grpc/internal/s0;->k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
...
.method static g(Ljava/util/Map;)Ljava/lang/Integer;
    ...
    .line 1
    invoke-static {p0, v0}, Lio/grpc/internal/s0;->i(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Integer;
...
.method static i(Ljava/util/Map;)Ljava/lang/Long;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static l(Ljava/util/Map;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, v0}, Lio/grpc/internal/s0;->f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
...
.method static m(Ljava/util/Map;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0, v0}, Lio/grpc/internal/s0;->k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
...
.method static o(Ljava/util/Map;)Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, v0}, Lio/grpc/internal/s1;->e(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {v1, v2, v0}, Lcom/google/common/base/q;->a(ZLjava/lang/String;Ljava/lang/Object;)V

    return-object p0
.end method

.method static p(Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static q(Ljava/util/Map;)Ljava/util/Set;
    ...
    .line 2
    invoke-static {v2, v3, v0}, Lcom/google/common/base/q;->a(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method private static s(Ljava/util/List;)Ljava/util/Set;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v4, v5, v1}, Lcom/google/common/base/q;->a(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v8, v2, v1}, Lcom/google/common/base/q;->a(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method static t(Ljava/util/Map;)Lio/grpc/internal/n1$x;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, v1}, Lio/grpc/internal/s0;->j(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 3
    invoke-static {p0, v1}, Lio/grpc/internal/s0;->h(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Double;
    ...
    .line 4
    invoke-static {v4, v5}, Lcom/google/common/base/j;->u(ZLjava/lang/Object;)V
    ...
    .line 6
    new-instance v1, Lio/grpc/internal/n1$x;

    invoke-direct {v1, v0, p0}, Lio/grpc/internal/n1$x;-><init>(FF)V

    return-object v1
.end method

.method static u(Ljava/util/Map;)Ljava/lang/Long;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static v(Ljava/util/Map;)Ljava/lang/Boolean;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, v0}, Lio/grpc/internal/s0;->d(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Boolean;
...
.method public static w(Ljava/util/Map;)Lio/grpc/internal/s1$a;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static x(Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    invoke-static {v1}, Lio/grpc/internal/s1;->w(Ljava/util/Map;)Lio/grpc/internal/s1$a;
