...
# instance fields
.field final synthetic c:Lio/grpc/internal/KeepAliveManager;
...
.method constructor <init>(Lio/grpc/internal/KeepAliveManager;)V
    ...
    .line 1
    iput-object p1, p0, Lio/grpc/internal/KeepAliveManager$b;->c:Lio/grpc/internal/KeepAliveManager;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Lio/grpc/internal/KeepAliveManager$b;->c:Lio/grpc/internal/KeepAliveManager;

    monitor-enter v0

    .line 2
    :try_start_0
    iget-object v1, p0, Lio/grpc/internal/KeepAliveManager$b;->c:Lio/grpc/internal/KeepAliveManager;
    ...
    .line 4
    iget-object v2, p0, Lio/grpc/internal/KeepAliveManager$b;->c:Lio/grpc/internal/KeepAliveManager;
    ...
    iget-object v4, p0, Lio/grpc/internal/KeepAliveManager$b;->c:Lio/grpc/internal/KeepAliveManager;

    invoke-static {v4}, Lio/grpc/internal/KeepAliveManager;->f(Lio/grpc/internal/KeepAliveManager;)Ljava/lang/Runnable;

    move-result-object v4

    iget-object v5, p0, Lio/grpc/internal/KeepAliveManager$b;->c:Lio/grpc/internal/KeepAliveManager;

    invoke-static {v5}, Lio/grpc/internal/KeepAliveManager;->g(Lio/grpc/internal/KeepAliveManager;)J
    ...
    invoke-static {v2, v3}, Lio/grpc/internal/KeepAliveManager;->e(Lio/grpc/internal/KeepAliveManager;Ljava/util/concurrent/ScheduledFuture;)Ljava/util/concurrent/ScheduledFuture;
    ...
    iget-object v7, p0, Lio/grpc/internal/KeepAliveManager$b;->c:Lio/grpc/internal/KeepAliveManager;

    invoke-static {v7}, Lio/grpc/internal/KeepAliveManager;->k(Lio/grpc/internal/KeepAliveManager;)Lcom/google/common/base/l;

    move-result-object v7

    sget-object v8, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v7, v8}, Lcom/google/common/base/l;->d(Ljava/util/concurrent/TimeUnit;)J
