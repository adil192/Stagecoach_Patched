...
.method static constructor <clinit>()V
    ...
    sget-object v10, Lio/grpc/Status;->l:Lio/grpc/Status;

    const-string v8, "Bandwidth exhausted"

    invoke-virtual {v10, v8}, Lio/grpc/Status;->r(Ljava/lang/String;)Lio/grpc/Status;
    ...
    sget-object v10, Lio/grpc/Status;->j:Lio/grpc/Status;

    const-string v6, "Permission denied as protocol is not secure enough to call"

    invoke-virtual {v10, v6}, Lio/grpc/Status;->r(Ljava/lang/String;)Lio/grpc/Status;
    ...
    .line 16
    invoke-static {}, Lio/grpc/internal/GrpcUtil$Http2Error;->j()[Lio/grpc/internal/GrpcUtil$Http2Error;
...
.method private constructor <init>(Ljava/lang/String;IILio/grpc/Status;)V
    ...
    invoke-virtual {p4, p1}, Lio/grpc/Status;->f(Ljava/lang/String;)Lio/grpc/Status;
...
.method private static j()[Lio/grpc/internal/GrpcUtil$Http2Error;
    .locals 7
