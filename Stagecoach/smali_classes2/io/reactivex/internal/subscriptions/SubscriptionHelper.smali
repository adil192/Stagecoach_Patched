...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    .line 4
    invoke-interface {p0}, Lk/a/c;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    .line 2
    invoke-interface {v0, p2, p3}, Lk/a/c;->request(J)V
    ...
    .line 7
    invoke-interface {p0, v0, v1}, Lk/a/c;->request(J)V
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lk/a/c;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lk/a/c;)Z
    ...
    .line 3
    invoke-interface {p2, p0, p1}, Lk/a/c;->request(J)V
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lk/a/c;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static validate(Lk/a/c;Lk/a/c;)Z
    .locals 1
    ...
    invoke-static {p0}, Lio/reactivex/g0/a;->s(Ljava/lang/Throwable;)V
