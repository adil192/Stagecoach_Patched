...
.field static final d:[Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
            "Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver<",
...
.method constructor <init>(Lio/reactivex/t;Lio/reactivex/c0/i;ZII)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/t;

    .line 4
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->mapper:Lio/reactivex/c0/i;
...
.method b()Z
    ...
    .line 7
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/t;
...
.method e()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/t;
    ...
    .line 3
    :cond_1
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lio/reactivex/d0/a/i;
    ...
    .line 5
    :cond_2
    invoke-interface {v3}, Lio/reactivex/d0/a/i;->poll()Ljava/lang/Object;
    ...
    .line 8
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lio/reactivex/d0/a/i;
    ...
    .line 15
    invoke-interface {v4}, Lio/reactivex/d0/a/j;->isEmpty()Z
    ...
    .line 28
    iget-object v11, v10, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lio/reactivex/d0/a/j;
    ...
    :cond_11
    :try_start_1
    invoke-interface {v11}, Lio/reactivex/d0/a/j;->poll()Ljava/lang/Object;
    ...
    .line 30
    :cond_12
    invoke-interface {v0, v12}, Lio/reactivex/t;->onNext(Ljava/lang/Object;)V
    ...
    .line 38
    iget-object v12, v10, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lio/reactivex/d0/a/j;
    ...
    .line 39
    invoke-interface {v12}, Lio/reactivex/d0/a/j;->isEmpty()Z
    ...
    .line 50
    invoke-virtual {p0, v4}, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->g(Lio/reactivex/s;)V
...
.method h(Ljava/lang/Object;Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;)V
    ...
    .line 2
    iget-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/t;
    ...
    .line 4
    :cond_0
    iget-object v0, p2, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lio/reactivex/d0/a/j;
    ...
    .line 6
    iput-object v0, p2, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lio/reactivex/d0/a/j;
...
.method i(Ljava/util/concurrent/Callable;)Z
    ...
    .line 3
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/t;
    ...
    .line 5
    :cond_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lio/reactivex/d0/a/i;
    ...
    .line 9
    :goto_0
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lio/reactivex/d0/a/i;

    .line 10
    :cond_3
    invoke-interface {v1, p1}, Lio/reactivex/d0/a/j;->offer(Ljava/lang/Object;)Z
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->mapper:Lio/reactivex/c0/i;
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->g(Lio/reactivex/s;)V
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    .line 3
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/t;
