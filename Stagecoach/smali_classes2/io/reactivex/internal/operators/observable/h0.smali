...
.method public constructor <init>(Lio/reactivex/s;I)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/h0;->c:Lio/reactivex/s;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/h0;->d:Ljava/util/concurrent/Callable;
...
.method public constructor <init>(Lio/reactivex/s;Ljava/util/concurrent/Callable;)V
    ...
    .line 6
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/h0;->d:Ljava/util/concurrent/Callable;
...
.method public E(Lio/reactivex/x;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/h0;->d:Ljava/util/concurrent/Callable;
    ...
    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/h0;->c:Lio/reactivex/s;

    new-instance v2, Lio/reactivex/internal/operators/observable/h0$a;

    invoke-direct {v2, p1, v0}, Lio/reactivex/internal/operators/observable/h0$a;-><init>(Lio/reactivex/x;Ljava/util/Collection;)V
...
.method public a()Lio/reactivex/p;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/h0;->d:Ljava/util/concurrent/Callable;

    invoke-direct {v0, v1, v2}, Lio/reactivex/internal/operators/observable/g0;-><init>(Lio/reactivex/s;Ljava/util/concurrent/Callable;)V
