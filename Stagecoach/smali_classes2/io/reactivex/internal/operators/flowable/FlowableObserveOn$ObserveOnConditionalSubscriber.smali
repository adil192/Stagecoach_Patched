...
.field final downstream:Lio/reactivex/d0/a/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(Lio/reactivex/d0/a/a;Lio/reactivex/u$c;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;-><init>(Lio/reactivex/u$c;ZI)V

    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lio/reactivex/d0/a/a;
...
.method c()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lio/reactivex/d0/a/a;

    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lio/reactivex/d0/a/j;
    ...
    .line 7
    :try_start_0
    invoke-interface {v1}, Lio/reactivex/d0/a/j;->poll()Ljava/lang/Object;
    ...
    .line 8
    :goto_2
    invoke-virtual {p0, v11, v13, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->b(ZZLk/a/b;)Z
    ...
    .line 9
    :cond_4
    invoke-interface {v0, v12}, Lio/reactivex/d0/a/a;->a(Ljava/lang/Object;)Z
    ...
    .line 11
    iget-object v10, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lk/a/c;

    invoke-interface {v10, v4, v5}, Lk/a/c;->request(J)V
    ...
    .line 14
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lk/a/c;

    invoke-interface {v3}, Lk/a/c;->cancel()V

    .line 15
    invoke-interface {v1}, Lio/reactivex/d0/a/j;->clear()V

    .line 16
    invoke-interface {v0, v2}, Lk/a/b;->onError(Ljava/lang/Throwable;)V

    .line 17
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->worker:Lio/reactivex/u$c;
    ...
    invoke-interface {v1}, Lio/reactivex/d0/a/j;->isEmpty()Z

    move-result v9

    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->b(ZZLk/a/b;)Z
...
.method d()V
    ...
    .line 3
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lio/reactivex/d0/a/a;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Lk/a/b;->onNext(Ljava/lang/Object;)V
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lio/reactivex/d0/a/a;

    invoke-interface {v1, v0}, Lk/a/b;->onError(Ljava/lang/Throwable;)V
...
.method e()V
    ...
    .line 10
    :cond_3
    invoke-interface {v0, v8}, Lio/reactivex/d0/a/a;->a(Ljava/lang/Object;)Z
    ...
    .line 13
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lk/a/c;

    invoke-interface {v2}, Lk/a/c;->cancel()V

    .line 14
    invoke-interface {v0, v1}, Lk/a/b;->onError(Ljava/lang/Throwable;)V
...
.method public onSubscribe(Lk/a/c;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lk/a/c;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lk/a/c;
    ...
    .line 7
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lio/reactivex/d0/a/j;

    .line 8
    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->done:Z

    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lio/reactivex/d0/a/a;

    invoke-interface {p1, p0}, Lio/reactivex/j;->onSubscribe(Lk/a/c;)V
    ...
    invoke-interface {v0, p0}, Lio/reactivex/j;->onSubscribe(Lk/a/c;)V
...
.method public poll()Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lio/reactivex/d0/a/j;
    ...
    invoke-interface {v3, v1, v2}, Lk/a/c;->request(J)V
