...
# static fields
.field static final c:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;

.field static final d:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;
...
.field volatile queue:Lio/reactivex/d0/a/j;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    .line 1
    sput-object v1, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->c:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;

    new-array v0, v0, [Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;

    .line 2
    sput-object v0, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->d:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;
...
.method constructor <init>(Ljava/util/concurrent/atomic/AtomicReference;I)V
    ...
    sget-object v1, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->c:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;
...
# virtual methods
.method b(Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    sget-object v1, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->d:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;
...
.method c(Ljava/lang/Object;Z)Z
    ...
    sget-object p2, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->d:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;
    ...
    .line 4
    iget-object v1, v1, Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;->child:Lk/a/b;

    invoke-interface {v1}, Lk/a/b;->onComplete()V
    ...
    .line 10
    iget-object v2, v2, Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;->child:Lk/a/b;

    invoke-interface {v2, p1}, Lk/a/b;->onError(Ljava/lang/Throwable;)V
...
.method d()V
    ...
    .line 5
    iget-object v6, v1, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->queue:Lio/reactivex/d0/a/j;

    if-eqz v6, :cond_3

    .line 6
    invoke-interface {v6}, Lio/reactivex/d0/a/j;->isEmpty()Z
    ...
    .line 13
    :try_start_0
    invoke-interface {v6}, Lio/reactivex/d0/a/j;->poll()Ljava/lang/Object;
    ...
    invoke-interface {v0, v9, v10}, Lk/a/c;->request(J)V
    ...
    .line 32
    :cond_d
    iget-object v3, v3, Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;->child:Lk/a/b;

    invoke-interface {v3, v8}, Lk/a/b;->onNext(Ljava/lang/Object;)V
    ...
    check-cast v3, Lk/a/c;

    int-to-long v6, v11

    invoke-interface {v3, v6, v7}, Lk/a/c;->request(J)V
    ...
    invoke-interface {v0, v12, v13}, Lk/a/c;->request(J)V
...
.method e(Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public onComplete()V
    ...
    .line 3
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->d()V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->queue:Lio/reactivex/d0/a/j;
...
.method public onSubscribe(Lk/a/c;)V
    ...
    invoke-static {v0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lk/a/c;)Z
    ...
    .line 6
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->queue:Lio/reactivex/d0/a/j;
