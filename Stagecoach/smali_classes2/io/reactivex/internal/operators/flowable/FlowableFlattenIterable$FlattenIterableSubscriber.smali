...
.field queue:Lio/reactivex/d0/a/j;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(Lk/a/b;Lio/reactivex/c0/g;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lk/a/b;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lio/reactivex/c0/g;
...
# virtual methods
.method b(ZZLk/a/b;Lio/reactivex/d0/a/j;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    .line 3
    invoke-interface {p4}, Lio/reactivex/d0/a/j;->clear()V
...
.method c(Z)V
    ...
    .line 4
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lk/a/c;
...
.method public cancel()V
    ...
    .line 5
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lio/reactivex/d0/a/j;
...
.method d()V
    ...
    .line 2
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lk/a/b;

    .line 3
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lio/reactivex/d0/a/j;
    ...
    .line 8
    :goto_2
    invoke-virtual {v1, v9, v11, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->b(ZZLk/a/b;Lio/reactivex/d0/a/j;)Z
    ...
    .line 9
    :try_start_1
    iget-object v6, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lio/reactivex/c0/g;

    invoke-interface {v6, v10}, Lio/reactivex/c0/g;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 12
    invoke-virtual {v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->c(Z)V
    ...
    .line 15
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lk/a/c;

    invoke-interface {v3}, Lk/a/c;->cancel()V
    ...
    .line 20
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lk/a/c;
    ...
    .line 24
    invoke-interface {v3}, Lio/reactivex/d0/a/j;->clear()V
    ...
    invoke-virtual {v1, v15, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->b(ZZLk/a/b;Lio/reactivex/d0/a/j;)Z
    ...
    invoke-static {v15, v5}, Lio/reactivex/internal/functions/a;->e(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_3

    .line 29
    invoke-interface {v2, v15}, Lk/a/b;->onNext(Ljava/lang/Object;)V

    .line 30
    iget-boolean v5, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    invoke-virtual {v1, v5, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->b(ZZLk/a/b;Lio/reactivex/d0/a/j;)Z
    ...
    .line 47
    invoke-interface {v3}, Lio/reactivex/d0/a/j;->isEmpty()Z
    ...
    .line 48
    :goto_6
    invoke-virtual {v1, v5, v15, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->b(ZZLk/a/b;Lio/reactivex/d0/a/j;)Z
...
.method public onComplete()V
    ...
    .line 3
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->d()V
...
.method public onSubscribe(Lk/a/c;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lk/a/c;
    ...
    check-cast v0, Lio/reactivex/d0/a/g;

    const/4 v1, 0x3

    .line 5
    invoke-interface {v0, v1}, Lio/reactivex/d0/a/f;->requestFusion(I)I
    ...
    .line 7
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lio/reactivex/d0/a/j;

    .line 8
    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lk/a/b;
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lk/a/b;
...
.method public poll()Ljava/lang/Object;
    ...
    .line 3
    :cond_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lio/reactivex/c0/g;

    invoke-interface {v2, v0}, Lio/reactivex/c0/g;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v2, v3}, Lio/reactivex/internal/functions/a;->e(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
