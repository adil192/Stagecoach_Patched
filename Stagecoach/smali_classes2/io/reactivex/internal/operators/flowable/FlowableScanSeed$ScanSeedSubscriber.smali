...
# instance fields
.field final accumulator:Lio/reactivex/c0/c;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/c0/c<",
            "TR;-TT;TR;>;"
...
# direct methods
.method constructor <init>(Lk/a/b;Lio/reactivex/c0/c;Ljava/lang/Object;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->downstream:Lk/a/b;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->accumulator:Lio/reactivex/c0/c;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->queue:Lio/reactivex/d0/a/i;

    .line 8
    invoke-interface {p1, p3}, Lio/reactivex/d0/a/j;->offer(Ljava/lang/Object;)Z
...
.method b()V
    ...
    .line 2
    :cond_0
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->downstream:Lk/a/b;

    .line 3
    iget-object v2, v0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->queue:Lio/reactivex/d0/a/i;
    ...
    .line 8
    invoke-interface {v2}, Lio/reactivex/d0/a/j;->clear()V
    ...
    .line 12
    invoke-interface {v1, v15}, Lk/a/b;->onError(Ljava/lang/Throwable;)V

    return-void

    .line 13
    :cond_4
    invoke-interface {v2}, Lio/reactivex/d0/a/i;->poll()Ljava/lang/Object;
    ...
    .line 16
    iget-object v4, v0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->upstream:Lk/a/c;

    int-to-long v13, v3

    invoke-interface {v4, v13, v14}, Lk/a/c;->request(J)V
    ...
    .line 20
    invoke-interface {v1, v7}, Lk/a/b;->onError(Ljava/lang/Throwable;)V

    return-void

    .line 21
    :cond_9
    invoke-interface {v2}, Lio/reactivex/d0/a/j;->isEmpty()Z
    ...
    invoke-static {v7, v11, v12}, Lio/reactivex/internal/util/b;->d(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public cancel()V
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->upstream:Lk/a/c;
    ...
    .line 4
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->queue:Lio/reactivex/d0/a/i;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 3
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->accumulator:Lio/reactivex/c0/c;

    invoke-interface {v1, v0, p1}, Lio/reactivex/c0/c;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public onSubscribe(Lk/a/c;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->upstream:Lk/a/c;

    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->downstream:Lk/a/b;
