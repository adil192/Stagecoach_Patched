...
.method constructor <init>(Landroid/content/Context;Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    .line 2
    iput-object p1, p0, Landroidx/media/k/a$a;->a:Landroid/content/Context;

    .line 3
    iput-object p2, p0, Landroidx/media/k/a$a;->b:Landroid/content/Intent;

    .line 4
    iput-object p3, p0, Landroidx/media/k/a$a;->c:Landroid/content/BroadcastReceiver$PendingResult;
...
.method private a()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/media/k/a$a;->d:Landroid/support/v4/media/MediaBrowserCompat;

    invoke-virtual {v0}, Landroid/support/v4/media/MediaBrowserCompat;->disconnect()V

    .line 2
    iget-object v0, p0, Landroidx/media/k/a$a;->c:Landroid/content/BroadcastReceiver$PendingResult;
...
.method b(Landroid/support/v4/media/MediaBrowserCompat;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media/k/a$a;->d:Landroid/support/v4/media/MediaBrowserCompat;
...
.method public onConnected()V
    ...
    iget-object v1, p0, Landroidx/media/k/a$a;->a:Landroid/content/Context;

    iget-object v2, p0, Landroidx/media/k/a$a;->d:Landroid/support/v4/media/MediaBrowserCompat;
    ...
    .line 3
    iget-object v1, p0, Landroidx/media/k/a$a;->b:Landroid/content/Intent;
    ...
    .line 5
    :catch_0
    invoke-direct {p0}, Landroidx/media/k/a$a;->a()V
