...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    .line 3
    iput-object p1, p0, Landroidx/multidex/MultiDexExtractor;->c:Ljava/io/File;

    .line 4
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->e:Ljava/io/File;

    .line 5
    invoke-static {p1}, Landroidx/multidex/MultiDexExtractor;->K(Ljava/io/File;)J

    move-result-wide v0

    iput-wide v0, p0, Landroidx/multidex/MultiDexExtractor;->d:J
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->g:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->h:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    .line 12
    :goto_0
    iget-object p2, p0, Landroidx/multidex/MultiDexExtractor;->g:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, Landroidx/multidex/MultiDexExtractor;->g(Ljava/io/Closeable;)V
    ...
    .line 14
    :goto_1
    iget-object p2, p0, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/RandomAccessFile;
...
.method private static A0(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    .locals 2
    ...
    .line 1
    invoke-static {p0}, Landroidx/multidex/MultiDexExtractor;->i(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method private static L(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p1}, Landroidx/multidex/MultiDexExtractor;->z(Ljava/io/File;)J
...
.method private b()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->e:Ljava/io/File;
    ...
    iget-object v1, p0, Landroidx/multidex/MultiDexExtractor;->e:Ljava/io/File;
...
.method private static h(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .line 18
    invoke-static {p0}, Landroidx/multidex/MultiDexExtractor;->g(Ljava/io/Closeable;)V
...
.method private l0(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v3, v0, Landroidx/multidex/MultiDexExtractor;->c:Ljava/io/File;
    ...
    .line 2
    invoke-static/range {p1 .. p1}, Landroidx/multidex/MultiDexExtractor;->i(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-object v9, v0, Landroidx/multidex/MultiDexExtractor;->e:Ljava/io/File;
    ...
    .line 8
    invoke-static {v8}, Landroidx/multidex/MultiDexExtractor;->K(Ljava/io/File;)J
...
.method private o0()Ljava/util/List;
    ...
    iget-object v9, p0, Landroidx/multidex/MultiDexExtractor;->e:Ljava/io/File;
    ...
    .line 10
    invoke-static {v4, v6, v8, v2}, Landroidx/multidex/MultiDexExtractor;->h(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
...
# virtual methods
.method R(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iget-object v2, p0, Landroidx/multidex/MultiDexExtractor;->h:Ljava/nio/channels/FileLock;
    ...
    iget-wide v3, p0, Landroidx/multidex/MultiDexExtractor;->d:J

    invoke-static {p1, v2, v3, v4, p2}, Landroidx/multidex/MultiDexExtractor;->L(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    .line 4
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/multidex/MultiDexExtractor;->l0(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 5
    :catch_0
    invoke-direct {p0}, Landroidx/multidex/MultiDexExtractor;->o0()Ljava/util/List;
    ...
    invoke-static {v0}, Landroidx/multidex/MultiDexExtractor;->z(Ljava/io/File;)J

    move-result-wide v2

    iget-wide v8, p0, Landroidx/multidex/MultiDexExtractor;->d:J
    ...
    invoke-static/range {v0 .. v6}, Landroidx/multidex/MultiDexExtractor;->A0(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public close()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->h:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    .line 2
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->g:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    .line 3
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/RandomAccessFile;
