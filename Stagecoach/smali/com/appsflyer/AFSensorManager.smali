...
.field private static final ɨ:Ljava/util/BitSet;

.field private static final ӏ:Landroid/os/Handler;
...
.field final ǃ:Landroid/os/Handler;

.field ȷ:J

.field ɩ:Z

.field private final ɪ:Ljava/lang/Runnable;
...
.field final Ι:Landroid/hardware/SensorManager;

.field final ι:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lcom/appsflyer/internal/t;",
...
.field final Ӏ:Ljava/lang/Runnable;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/appsflyer/AFSensorManager;->ɨ:Ljava/util/BitSet;
    ...
    sput-object v1, Lcom/appsflyer/AFSensorManager;->ӏ:Landroid/os/Handler;
...
.method private constructor <init>(Landroid/hardware/SensorManager;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/appsflyer/AFSensorManager;->ı:Ljava/lang/Object;

    .line 3
    new-instance v0, Ljava/util/HashMap;

    sget-object v1, Lcom/appsflyer/AFSensorManager;->ɨ:Ljava/util/BitSet;
    ...
    iput-object v0, p0, Lcom/appsflyer/AFSensorManager;->ι:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcom/appsflyer/AFSensorManager;->Ӏ:Ljava/lang/Runnable;
    ...
    .line 9
    iput-wide v0, p0, Lcom/appsflyer/AFSensorManager;->ȷ:J
    ...
    iput-object v0, p0, Lcom/appsflyer/AFSensorManager;->ɪ:Ljava/lang/Runnable;

    .line 11
    iput-object p1, p0, Lcom/appsflyer/AFSensorManager;->Ι:Landroid/hardware/SensorManager;
...
.method static synthetic ı(Lcom/appsflyer/AFSensorManager;)I
    .locals 0
...
.method private static ı(Landroid/hardware/SensorManager;Landroid/os/Handler;)Lcom/appsflyer/AFSensorManager;
    .locals 2
...
.method static ɩ(Landroid/content/Context;)Lcom/appsflyer/AFSensorManager;
    ...
    .line 5
    sget-object v0, Lcom/appsflyer/AFSensorManager;->ӏ:Landroid/os/Handler;

    invoke-static {p0, v0}, Lcom/appsflyer/AFSensorManager;->ı(Landroid/hardware/SensorManager;Landroid/os/Handler;)Lcom/appsflyer/AFSensorManager;
...
.method static Ι(I)Z
    ...
    .line 2
    sget-object v0, Lcom/appsflyer/AFSensorManager;->ɨ:Ljava/util/BitSet;
...
.method static synthetic ι(Lcom/appsflyer/AFSensorManager;)Ljava/lang/Runnable;
    ...
    .line 1
    iget-object p0, p0, Lcom/appsflyer/AFSensorManager;->ɪ:Ljava/lang/Runnable;
...
# virtual methods
.method final ǃ()Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    iget-object v0, p0, Lcom/appsflyer/AFSensorManager;->ı:Ljava/lang/Object;

    monitor-enter v0

    .line 2
    :try_start_0
    iget-object v1, p0, Lcom/appsflyer/AFSensorManager;->ι:Ljava/util/Map;
    ...
    iget-boolean v1, p0, Lcom/appsflyer/AFSensorManager;->І:Z
    ...
    .line 4
    iget-object v3, p0, Lcom/appsflyer/AFSensorManager;->ɾ:Ljava/util/Map;

    const/4 v4, 0x0

    .line 5
    invoke-virtual {v2, v3, v4}, Lcom/appsflyer/internal/t;->Ι(Ljava/util/Map;Z)V
    ...
    iget-object v2, p0, Lcom/appsflyer/AFSensorManager;->ɾ:Ljava/util/Map;
...
.method final ɩ()V
    ...
    .line 6
    :try_start_0
    iget-object v0, p0, Lcom/appsflyer/AFSensorManager;->ι:Ljava/util/Map;
    ...
    .line 8
    iget-object v2, p0, Lcom/appsflyer/AFSensorManager;->Ι:Landroid/hardware/SensorManager;
    ...
    .line 10
    invoke-virtual {v1, v2, v3}, Lcom/appsflyer/internal/t;->Ι(Ljava/util/Map;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 12
    iput-boolean v0, p0, Lcom/appsflyer/AFSensorManager;->І:Z
