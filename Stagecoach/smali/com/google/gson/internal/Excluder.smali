...
.method private d(Ljava/lang/Class;)Z
    ...
    const-class v0, Lcom/google/gson/p/d;

    invoke-virtual {p1, v0}, Ljava/lang/Class;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v0

    check-cast v0, Lcom/google/gson/p/d;

    const-class v1, Lcom/google/gson/p/e;

    invoke-virtual {p1, v1}, Ljava/lang/Class;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v1

    check-cast v1, Lcom/google/gson/p/e;

    invoke-direct {p0, v0, v1}, Lcom/google/gson/internal/Excluder;->n(Lcom/google/gson/p/d;Lcom/google/gson/p/e;)Z
...
.method private j(Ljava/lang/Class;)Z
    ...
    invoke-direct {p0, p1}, Lcom/google/gson/internal/Excluder;->k(Ljava/lang/Class;)Z
...
.method private l(Lcom/google/gson/p/d;)Z
    .locals 4

    if-eqz p1, :cond_0

    .line 1
    invoke-interface {p1}, Lcom/google/gson/p/d;->value()D
...
.method private m(Lcom/google/gson/p/e;)Z
    .locals 4

    if-eqz p1, :cond_0

    .line 1
    invoke-interface {p1}, Lcom/google/gson/p/e;->value()D
...
.method private n(Lcom/google/gson/p/d;Lcom/google/gson/p/e;)Z
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/google/gson/internal/Excluder;->l(Lcom/google/gson/p/d;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lcom/google/gson/internal/Excluder;->m(Lcom/google/gson/p/e;)Z
...
.method public a(Lcom/google/gson/Gson;Lcom/google/gson/q/a;)Lcom/google/gson/TypeAdapter;
    ...
    invoke-direct/range {v5 .. v10}, Lcom/google/gson/internal/Excluder$1;-><init>(Lcom/google/gson/internal/Excluder;ZZLcom/google/gson/Gson;Lcom/google/gson/q/a;)V
...
.method public f(Ljava/lang/reflect/Field;Z)Z
    ...
    const-class v2, Lcom/google/gson/p/e;

    invoke-virtual {p1, v2}, Ljava/lang/reflect/Field;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v2

    check-cast v2, Lcom/google/gson/p/e;

    invoke-direct {p0, v0, v2}, Lcom/google/gson/internal/Excluder;->n(Lcom/google/gson/p/d;Lcom/google/gson/p/e;)Z
    ...
    .line 6
    const-class v0, Lcom/google/gson/p/a;

    invoke-virtual {p1, v0}, Ljava/lang/reflect/Field;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v0

    check-cast v0, Lcom/google/gson/p/a;
    ...
    .line 7
    invoke-interface {v0}, Lcom/google/gson/p/a;->serialize()Z
    ...
    :cond_3
    invoke-interface {v0}, Lcom/google/gson/p/a;->deserialize()Z
