...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/bumptech/glide/load/engine/x/n$c;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/engine/x/n;->f:[Landroid/graphics/Bitmap$Config;
    ...
    sput-object v0, Lcom/bumptech/glide/load/engine/x/n;->g:[Landroid/graphics/Bitmap$Config;
    ...
    sput-object v0, Lcom/bumptech/glide/load/engine/x/n;->h:[Landroid/graphics/Bitmap$Config;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/x/n;->c:Ljava/util/Map;
...
.method private f(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
    ...
    .line 2
    invoke-direct {p0, v0}, Lcom/bumptech/glide/load/engine/x/n;->j(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
    ...
    .line 8
    invoke-virtual {p0, p2}, Lcom/bumptech/glide/load/engine/x/n;->e(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method private g(ILandroid/graphics/Bitmap$Config;)Lcom/bumptech/glide/load/engine/x/n$b;
    .locals 8

    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/x/n;->a:Lcom/bumptech/glide/load/engine/x/n$c;

    invoke-virtual {v0, p1, p2}, Lcom/bumptech/glide/load/engine/x/n$c;->e(ILandroid/graphics/Bitmap$Config;)Lcom/bumptech/glide/load/engine/x/n$b;

    move-result-object v0

    .line 2
    invoke-static {p2}, Lcom/bumptech/glide/load/engine/x/n;->i(Landroid/graphics/Bitmap$Config;)[Landroid/graphics/Bitmap$Config;
    ...
    .line 3
    invoke-direct {p0, v4}, Lcom/bumptech/glide/load/engine/x/n;->j(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
    ...
    invoke-virtual {p1, v0}, Lcom/bumptech/glide/load/engine/x/d;->c(Lcom/bumptech/glide/load/engine/x/m;)V
    ...
    invoke-virtual {p1, p2, v4}, Lcom/bumptech/glide/load/engine/x/n$c;->e(ILandroid/graphics/Bitmap$Config;)Lcom/bumptech/glide/load/engine/x/n$b;
...
.method public a(IILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p1, p2, p3}, Lcom/bumptech/glide/o/k;->f(IILandroid/graphics/Bitmap$Config;)I

    move-result p1

    .line 2
    invoke-static {p1, p3}, Lcom/bumptech/glide/load/engine/x/n;->h(ILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
...
.method public b(Landroid/graphics/Bitmap;)I
    ...
    .line 1
    invoke-static {p1}, Lcom/bumptech/glide/o/k;->g(Landroid/graphics/Bitmap;)I
...
.method public c(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v1, v0, v2}, Lcom/bumptech/glide/load/engine/x/n$c;->e(ILandroid/graphics/Bitmap$Config;)Lcom/bumptech/glide/load/engine/x/n$b;
    ...
    invoke-virtual {v1, v0, p1}, Lcom/bumptech/glide/load/engine/x/h;->d(Lcom/bumptech/glide/load/engine/x/m;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/engine/x/n;->j(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
...
.method public d(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 2
    invoke-direct {p0, v0, p3}, Lcom/bumptech/glide/load/engine/x/n;->g(ILandroid/graphics/Bitmap$Config;)Lcom/bumptech/glide/load/engine/x/n$b;
    ...
    invoke-virtual {v1, v0}, Lcom/bumptech/glide/load/engine/x/h;->a(Lcom/bumptech/glide/load/engine/x/m;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v0, v1}, Lcom/bumptech/glide/load/engine/x/n;->f(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
...
.method public e(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-static {v0, p1}, Lcom/bumptech/glide/load/engine/x/n;->h(ILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
...
.method public removeLast()Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v1, v0}, Lcom/bumptech/glide/load/engine/x/n;->f(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
