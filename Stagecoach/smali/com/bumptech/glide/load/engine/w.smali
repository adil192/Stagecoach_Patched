...
.method private b(Ljava/lang/Object;)V
    ...
    .line 2
    :try_start_0
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/f;
    ...
    iget-object v4, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/f;
    ...
    invoke-direct {v3, v2, p1, v4}, Lcom/bumptech/glide/load/engine/d;-><init>(Lcom/bumptech/glide/load/a;Ljava/lang/Object;Lcom/bumptech/glide/load/e;)V

    .line 5
    new-instance v4, Lcom/bumptech/glide/load/engine/c;

    iget-object v5, p0, Lcom/bumptech/glide/load/engine/w;->h:Lcom/bumptech/glide/load/j/n$a;

    iget-object v5, v5, Lcom/bumptech/glide/load/j/n$a;->a:Lcom/bumptech/glide/load/c;

    iget-object v6, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/f;
    ...
    iput-object v4, p0, Lcom/bumptech/glide/load/engine/w;->i:Lcom/bumptech/glide/load/engine/c;
    ...
    invoke-interface {v4, v5, v3}, Lcom/bumptech/glide/load/engine/y/a;->a(Lcom/bumptech/glide/load/c;Lcom/bumptech/glide/load/engine/y/a$b;)V
    ...
    iget-object v4, p0, Lcom/bumptech/glide/load/engine/w;->i:Lcom/bumptech/glide/load/engine/c;
    ...
    .line 10
    :cond_0
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/w;->h:Lcom/bumptech/glide/load/j/n$a;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/w;->h:Lcom/bumptech/glide/load/j/n$a;
...
.method private g(Lcom/bumptech/glide/load/j/n$a;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1}, Lcom/bumptech/glide/load/engine/w$a;-><init>(Lcom/bumptech/glide/load/engine/w;Lcom/bumptech/glide/load/j/n$a;)V

    .line 3
    invoke-interface {v0, v1, v2}, Lcom/bumptech/glide/load/i/d;->e(Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/i/d$a;)V
...
.method public a()Z
    ...
    .line 6
    iput-object v1, p0, Lcom/bumptech/glide/load/engine/w;->h:Lcom/bumptech/glide/load/j/n$a;
    ...
    .line 9
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/w;->h:Lcom/bumptech/glide/load/j/n$a;
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/w;->h:Lcom/bumptech/glide/load/j/n$a;

    iget-object v3, v3, Lcom/bumptech/glide/load/j/n$a;->c:Lcom/bumptech/glide/load/i/d;

    invoke-interface {v3}, Lcom/bumptech/glide/load/i/d;->d()Lcom/bumptech/glide/load/DataSource;
    ...
    invoke-direct {p0, v0}, Lcom/bumptech/glide/load/engine/w;->g(Lcom/bumptech/glide/load/j/n$a;)V
...
.method d(Lcom/bumptech/glide/load/j/n$a;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method e(Lcom/bumptech/glide/load/j/n$a;Ljava/lang/Object;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iget-object v1, p1, Lcom/bumptech/glide/load/j/n$a;->c:Lcom/bumptech/glide/load/i/d;

    invoke-interface {v1}, Lcom/bumptech/glide/load/i/d;->d()Lcom/bumptech/glide/load/DataSource;
    ...
    .line 3
    iput-object p2, p0, Lcom/bumptech/glide/load/engine/w;->g:Ljava/lang/Object;

    .line 4
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/w;->d:Lcom/bumptech/glide/load/engine/e$a;

    invoke-interface {p1}, Lcom/bumptech/glide/load/engine/e$a;->k()V
    ...
    iget-object v1, p1, Lcom/bumptech/glide/load/j/n$a;->a:Lcom/bumptech/glide/load/c;

    iget-object v3, p1, Lcom/bumptech/glide/load/j/n$a;->c:Lcom/bumptech/glide/load/i/d;
...
.method f(Lcom/bumptech/glide/load/j/n$a;Ljava/lang/Exception;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1}, Lcom/bumptech/glide/load/i/d;->d()Lcom/bumptech/glide/load/DataSource;

    move-result-object v2

    invoke-interface {v0, v1, p2, p1, v2}, Lcom/bumptech/glide/load/engine/e$a;->j(Lcom/bumptech/glide/load/c;Ljava/lang/Exception;Lcom/bumptech/glide/load/i/d;Lcom/bumptech/glide/load/DataSource;)V
...
.method public j(Lcom/bumptech/glide/load/c;Ljava/lang/Exception;Lcom/bumptech/glide/load/i/d;Lcom/bumptech/glide/load/DataSource;)V
    ...
    invoke-interface {v0}, Lcom/bumptech/glide/load/i/d;->d()Lcom/bumptech/glide/load/DataSource;

    move-result-object v0

    invoke-interface {p4, p1, p2, p3, v0}, Lcom/bumptech/glide/load/engine/e$a;->j(Lcom/bumptech/glide/load/c;Ljava/lang/Exception;Lcom/bumptech/glide/load/i/d;Lcom/bumptech/glide/load/DataSource;)V
...
.method public o(Lcom/bumptech/glide/load/c;Ljava/lang/Object;Lcom/bumptech/glide/load/i/d;Lcom/bumptech/glide/load/DataSource;Lcom/bumptech/glide/load/c;)V
    ...
    iget-object p4, p0, Lcom/bumptech/glide/load/engine/w;->h:Lcom/bumptech/glide/load/j/n$a;

    iget-object p4, p4, Lcom/bumptech/glide/load/j/n$a;->c:Lcom/bumptech/glide/load/i/d;

    invoke-interface {p4}, Lcom/bumptech/glide/load/i/d;->d()Lcom/bumptech/glide/load/DataSource;
